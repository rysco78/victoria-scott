export default function Footer() {
  return (
    <footer
      style={{ backgroundColor: '#ffffff', borderTop: '1px solid #e8e8e8' }}
      className="py-6"
    >
      <div
      ...
      >
        <p style={{ fontSize: '14px', color: '#777777' }}>
          © {new Date().getFullYear()} Victoria Scott. All rights reserved
        </p>
        <div className="flex items-center gap-5">
          ...
          <a
            href="https://www.facebook.com/heytoriscott"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Facebook"
            style={{ color: '#777777' }}
